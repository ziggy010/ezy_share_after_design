...
const kNavbarColor = Color(0xFF585CE5);
const kBackgroundColor = Color(0xFFFAFAFF);
const kContainerColor = Color(0xFFEEEEFF);

const kNavbarText = TextStyle(
  fontFamily: 'poppins',
  fontSize: 16,
  fontWeight: FontWeight.w400,
);
const kContainerPrimaryColor = Color(0xFF585CE5);
...
var kCardButtonText = TextStyle(
  color: Colors.white,
  fontSize: 16.sp,
  fontWeight: FontWeight.bold,
  fontFamily: 'poppins',
);
var kRegButtonText = TextStyle(
  color: Colors.white,
  fontSize: 16.sp,
  fontWeight: FontWeight.bold,
  fontFamily: 'poppins',
);
var kSigninButtonText = TextStyle(
  color: Colors.white,
  fontSize: 16.sp,
  fontWeight: FontWeight.bold,
  fontFamily: 'poppins',
...
var kSigninBodySmallText = TextStyle(
  color: Colors.black,
  fontSize: 12.sp,
  fontFamily: 'poppins',
);
